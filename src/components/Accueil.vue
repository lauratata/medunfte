<template>
    <div>
        <nav class="navbar">
            ...
            <div class="nav-links">
                <ul>
                    <li><a href="#">le projet abyssal</a></li>
                    <li><a href="#">medunfte nft collection</a></li>
                    <li><a href="#">offf barcelone 2023</a></li>
                    <li>
        ...
        <body>
            <header>
                <h1>Medunfte</h1>
                <button>Découvrez la collection</button>
            </header>
          ...
          <div class="subcolumn">
            ...
            <section>
                ...
                <swiper-container class="mySwiper" pagination="true" effect="coverflow" grab-cursor="true"
                    ...
                    coverflow-effect-depth="100" coverflow-effect-modifier="1" coverflow-effect-slide-shadows="false"
